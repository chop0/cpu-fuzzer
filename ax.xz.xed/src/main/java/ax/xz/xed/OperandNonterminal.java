...
public enum OperandNonterminal {
	...
	AVX256_ROUND(XED_NONTERMINAL_AVX256_ROUND()),
	...
	FIX_ROUND_LEN256(XED_NONTERMINAL_FIX_ROUND_LEN256()),
	...
	OperandNonterminal(int xedEnum) {
	...
	public static OperandNonterminal from(int xedEnum) {
