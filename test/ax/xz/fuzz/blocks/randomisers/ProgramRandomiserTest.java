...
class ProgramRandomiserTest {
	ProgramRandomiser programRandomiser = new ProgramRandomiser();
...
//		rng.setSeed(0);
	...
	void reverseTestCase() {
		var tc = programRandomiser.selectTestCase(rng, rp);
		programRandomiser.reverseTestCase(rrng, rp, tc);
		var playbackRng = rrng.flip();
		var tc2 = programRandomiser.selectTestCase(playbackRng, rp);
	...
	void reverseCPUState() {
		var cs = programRandomiser.selectCPUState(rng, rp);
		programRandomiser.reverseCPUState(rrng, rp, cs);
		var playbackRng = rrng.flip();
		var cs2 = programRandomiser.selectCPUState(playbackRng, rp);
	...
	void reverseInterestingValue() {
		var iv = programRandomiser.selectInterestingValue(rng, rp);
		programRandomiser.reverseInterestingValue(rrng, rp, iv);
		var playbackRng = rrng.flip();
		var iv2 = programRandomiser.selectInterestingValue(playbackRng, rp);
	...
	void reverseSequence() {
		var pairs = programRandomiser.selectBlockPairs(rng, rp, 5);
	...
	void reverseInterleaved() {
		var pair = programRandomiser.selectBlockPair(rng, rp);
	...
	void reverseBlockPairs() {
		...
		var playbackRng = rrng.flip();
		var pairs2 = programRandomiser.selectBlockPairs(playbackRng, rp, 5);
	...
	void reverseBlockPair() {
		...
		var playbackRng = rrng.flip();
		var pair2 = programRandomiser.selectBlockPair(playbackRng, rp);
	...
	void reverseResourceSplit() {
		var rs = programRandomiser.selectResourceSplit(rng, rp);
		programRandomiser.reverseResourceSplit(rrng, rs.getKey(), rs.getValue());
		var playbackRng = rrng.flip();
		var rs2 = programRandomiser.selectResourceSplit(playbackRng, rp);
	...
	void reverseMemorySplit() {
		var ms = programRandomiser.selectMemorySplit(rng, rp.memory());
		programRandomiser.reverseMemorySplit(rrng, ms.getKey(), ms.getValue());
		var playbackRng = rrng.flip();
		var ms2 = programRandomiser.selectMemorySplit(playbackRng, rp.memory());
